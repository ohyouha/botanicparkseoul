...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function initGarden() {
        ...
        const gardenData = [
            ...
            { name: '느티나무', place: '열린숲', desc: '드넓은 잔디마당과 나무들 사이에서\n누구나 편히 쉴 수 있는 식물원의 입구입니다.', color: '#3d6e4d', img: './img/garden2.jpg' },
            { name: '꽃창포', place: '호수원', desc: '수변 산책로를 따라 흐르는 물결과\n식물의 조화를 느낄 수 있는 휴식처입니다.', color: '#4a6fa8', img: './img/garden3.jpg' },
            { name: '낙우송', place: '습지원', desc: '자연 그대로의 습지 생태계를 보존하여\n생물의 다양성을 관찰할 수 있는 구역입니다.', color: '#4a7a6a', img: './img/garden4.jpg' },
            { name: '억새', place: '햇살정원', desc: '따스한 햇볕 아래 바람에 흔들리는\n풀잎들의 질감을 가장 잘 느낄 수 있는 정원입니다.', color: '#a07840', img: './img/garden5.jpg' },
            { name: '튤립', place: '해봄정원', desc: '계절마다 피어나는 꽃들을 통해\n새로운 생명력을 직접 마주하는 공간입니다.', color: '#b06080', img: './img/garden6.jpg' },
            { name: '수국', place: '정원사의 정원', desc: '가드너의 손길이 닿은 섬세한 식재 조합과\n정원 가꾸기의 즐거움을 보여줍니다.', color: '#6070a0', img: './img/garden7.jpg' },
            { name: '조팝나무', place: '시소정원', desc: '아이들의 눈높이에 맞춘 식물들과\n재미있는 조형물이 어우러진 체험형 공간입니다.', color: '#a09040', img: './img/garden8.jpg' },
            { name: '남천', place: '입구정원', desc: '방문객을 가장 먼저 맞이하며\n사계절의 변화를 직관적으로 보여주는 정원입니다.', color: '#904030', img: './img/garden9.jpg' },
            { name: '붓꽃', place: '아이리스원', desc: '다채로운 색과 모양을 가진\n아이리스 품종들을 집중적으로 감상할 수 있는 정원입니다.', color: '#7050a0', img: './img/garden10.jpg' },
            { name: '소나무', place: '숲문화원', desc: '울창한 나무들이 만드는 숲의 정취 속에서\n문화와 교육을 함께 즐기는 공간입니다.', color: '#406040', img: './img/garden11.jpg' },
        ];
        ...
        function getSizes() {
            ...
            // 원 크기
            const MAIN_SIZE = isMobile ? Math.min(300, BASE * 0.85)
                : is1280 ? Math.min(490, BASE * 0.62)
                    : Math.min(640, BASE * 0.75);
            ...
            const anglePrev = angleMain - 0.60;
            const angleNext = angleMain + 0.60;
 ...
 function initHeaderScroll() {
    ...
    function updateHeader() {
        ...
        if (isScrolled) {
            ...
            document.querySelectorAll('.top_links a').forEach(a => a.style.color = '#1a3a24');
            ...
            document.querySelectorAll('.top_links a').forEach(a => a.style.color = 'rgba(255,255,255,0.85)');
            const logo1 = document.querySelector('.seoul_logo img');
            const logo2 = document.querySelector('.site_logo img');
